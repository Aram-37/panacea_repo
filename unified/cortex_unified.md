...
# Additional Framework Support Classes
class TeacherState:
...
class RefinementCycleResult:
    def __init__(self, cycle_number: int, round_number: int, refined_content: str, acceleration_applied: Dict[str, float]):
        self.cycle_number = cycle_number
        self.round_number = round_number
        self.refined_content = refined_content
        self.acceleration_applied = acceleration_applied
